<template>
  <section class="rounded">
    ...
    <div
      class="flex items-center mb-20 rounded p-4 bg-white border justify-center border-gray-100 top-6 dark:bg-gray-700 dark:border-gray-600"
    >
      <div
        class="flex flex-col items-center mb-3 mr-4 md:items-center md:flex-row md:mb-0"
      >
        <div class="border-gray-200 me-2">
