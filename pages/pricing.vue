    ...
    <div class="py-8 px-4 lg:py-16 lg:px-6">
      <div id="detailed-pricing" class="overflow-x-auto mt-8 w-full">
        <div class="overflow-hidden min-w-max">
          ...
          >
            <div class="flex items-center">General</div>
            <div>Professional Edition</div>
            <div>Advance Edition</div>
          ...
          >
            <div class="text-gray-500 dark:text-gray-400">Live Connection</div>
            <div>
              <svg
          ...
          <div
            class="grid grid-cols-4 gap-x-16 py-5 px-4 text-sm text-gray-700 border-b border-gray-200 dark:border-gray-700"
          >
            <div class="text-gray-500 dark:text-gray-400">Data Priority</div>
            <div>
              <svg
          ...
          >
            ...
            <div>Ticket, Email (24 Hours)</div>
            <div>Ticket, Email, Phone (8 Hours)</div>
            <div>Ticket, Email, Phone (>One Hour)</div>
          </div>
          <div
            class="grid grid-cols-4 gap-x-16 py-5 px-4 text-sm text-gray-700 border-b border-gray-200 dark:border-gray-700"
          >
            <div class="text-gray-500 dark:text-gray-400">Markets</div>
            <div>Forex, Stocks, Crypto</div>
            <div>
              Forex, Stocks, Crypto, <br />
              Commodities, Indices
            </div>
            <div>
              Forex, Stocks, Crypto, <br />
              Commodities, Indices, <br />
              Futures, Bond, Options
            </div>
          </div>
          <div
            class="grid grid-cols-4 gap-x-16 p-4 text-sm font-medium text-gray-900 bg-gray-100 border-t border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 dark:text-white"
          ...
          <div
            class="grid grid-cols-4 gap-x-16 py-5 px-4 text-sm text-gray-700 border-b border-gray-200 dark:border-gray-700"
          >
            <div class="text-gray-500 dark:text-gray-400">Supply Demand</div>
            <div>
              <svg
                class="w-6 h-6 text-green-500"
                fill="currentColor"
          ...
          <div
            class="grid grid-cols-4 gap-x-16 py-5 px-4 text-sm text-gray-700 border-b border-gray-200 dark:border-gray-700"
          >
            <div class="text-gray-500 dark:text-gray-400">Algo Portfolio</div>
            <div>
              <svg
                class="w-6 h-6 text-green-500"
                fill="currentColor"
          ...
          <div
            class="grid grid-cols-4 gap-x-16 py-5 px-4 text-sm text-gray-700 border-b border-gray-200 dark:border-gray-700"
          >
            <div class="text-gray-500 dark:text-gray-400">Trend Friend</div>
            <div>
              <svg
                class="w-6 h-6 text-red-500"
                fill="currentColor"
          ...
          <div
            class="grid grid-cols-4 gap-x-16 py-5 px-4 text-sm text-gray-700 border-b border-gray-200 dark:border-gray-700"
          >
            <div class="text-gray-500 dark:text-gray-400">Dashboard X</div>
            <div>
              <svg
                class="w-6 h-6 text-red-500"
                fill="currentColor"
          ...
          <div
            class="grid grid-cols-4 gap-x-16 py-5 px-4 text-sm text-gray-700 border-b border-gray-200 dark:border-gray-700"
          >
            <div class="text-gray-500 dark:text-gray-400">Tchimoku</div>
            <div>
              <svg
                class="w-6 h-6 text-red-500"
                fill="currentColor"
          ...
          <div
            class="grid grid-cols-4 gap-x-16 p-4 text-sm font-medium text-gray-900 bg-gray-100 border-t border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 dark:text-white"
          >
            <div class="flex items-center">Financial Engineering</div>
            <div>Professional Edition</div>
            <div>Advance Edition</div>
            <div>Corporate Edition</div>
          </div>
          <div
            class="grid grid-cols-4 gap-x-16 py-5 px-4 text-sm text-gray-700 border-b border-gray-200 dark:border-gray-700"
          >
            <div class="text-gray-500 dark:text-gray-400">Risk Management</div>
            <div>
              <svg
                class="w-6 h-6 text-green-500"
                fill="currentColor"
          ...
          <div
            class="grid grid-cols-4 gap-x-16 py-5 px-4 text-sm text-gray-700 border-b border-gray-200 dark:border-gray-700"
          >
            <div class="text-gray-500 dark:text-gray-400">Money Management</div>
            <div>
              <svg
                class="w-6 h-6 text-red-500"
                fill="currentColor"
          ...
          <div
            class="grid grid-cols-4 gap-x-16 py-5 px-4 text-sm text-gray-700 border-b border-gray-200 dark:border-gray-700"
          >
            <div class="text-gray-500 dark:text-gray-400">Trading Plan</div>
            <div>
              <svg
                class="w-6 h-6 text-red-500"
                fill="currentColor"
          ...
          <div
            class="grid grid-cols-4 gap-x-16 py-5 px-4 text-sm text-gray-700 border-b border-gray-200 dark:border-gray-700"
          >
            <div class="text-gray-500 dark:text-gray-400">Cash Flow</div>
            <div>
              <svg
                class="w-6 h-6 text-red-500"
                fill="currentColor"
          ...
          >
            ...
            <div>Basic</div>
            <div>Full Report</div>
            <div>Full Report + AI Recommendations</div>
          </div>
          <div
          ...
          >
            <div class="flex items-center">Open APIs</div>
            <div>Professional Edition</div>
            <div>Advance Edition</div>
            <div>Corporate Edition</div>
          </div>
          <div
            class="grid grid-cols-4 gap-x-16 py-5 px-4 text-sm text-gray-700 border-b border-gray-200 dark:border-gray-700"
          >
            <div class="text-gray-500 dark:text-gray-400">Daily Credits</div>
            <div>100,000</div>
            <div>500,000</div>
            <div>1,000,000</div>
          </div>
          ...
          <div
            class="grid grid-cols-4 gap-x-16 py-5 px-4 text-sm text-gray-700 border-b border-gray-200 dark:border-gray-700"
          >
            <div class="text-gray-500 dark:text-gray-400">Market Data</div>
            <div>
              <svg
                class="w-6 h-6 text-green-500"
                fill="currentColor"
          ...
          <div
            class="grid grid-cols-4 gap-x-16 p-4 text-sm font-medium text-gray-900 bg-gray-100 border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 dark:text-white"
          >
            <div class="flex items-center">Bridge</div>
            <div>Professional Edition</div>
            <div>Advance Edition</div>
            <div>Corporate Edition</div>
          </div>
          ...
          <div
            class="grid grid-cols-4 gap-x-16 py-5 px-4 text-sm text-gray-700 border-b border-gray-200 dark:border-gray-700"
          >
            <div class="text-gray-500 dark:text-gray-400">Custom Cluster</div>
            <div>
              <svg
                class="w-6 h-6 text-red-500"
                fill="currentColor"
          ...
          <div
            class="grid grid-cols-4 gap-x-16 py-5 px-4 text-sm text-gray-700 border-b border-gray-200 dark:border-gray-700"
          >
            <div class="text-gray-500 dark:text-gray-400">ML Processing</div>
            <div>
              <svg
                class="w-6 h-6 text-red-500"
                fill="currentColor"
          ...
          <div
            class="grid grid-cols-4 gap-x-16 p-4 text-sm font-medium text-gray-900 bg-gray-100 border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 dark:text-white"
          >
            <div class="flex items-center">Bazaar</div>
            <div>Professional Edition</div>
            <div>Advance Edition</div>
            <div>Corporate Edition</div>
          </div>
          <div
            class="grid grid-cols-4 gap-x-16 py-5 px-4 text-sm text-gray-700 border-b border-gray-200 dark:border-gray-700"
          >
            <div class="text-gray-500 dark:text-gray-400">Badge</div>
            <div>
              <svg
                class="w-6 h-6 text-green-500"
                fill="currentColor"
          ...
          <div
            class="grid grid-cols-4 gap-x-16 py-5 px-4 text-sm text-gray-700 border-b border-gray-200 dark:border-gray-700"
          >
            <div class="text-gray-500 dark:text-gray-400">Profile</div>
            <div>
              <svg
                class="w-6 h-6 text-green-500"
                fill="currentColor"
          ...
          <div
            class="grid grid-cols-4 gap-x-16 py-5 px-4 text-sm text-gray-700 border-b border-gray-200 dark:border-gray-700"
          >
            <div class="text-gray-500 dark:text-gray-400">Copy Protector</div>
            <div>
              <svg
                class="w-6 h-6 text-red-500"
                fill="currentColor"
          ...
          <div
            class="grid grid-cols-4 gap-x-16 py-5 px-4 text-sm text-gray-700 border-b border-gray-200 dark:border-gray-700"
          >
            <div class="text-gray-500 dark:text-gray-400">White Label</div>
            <div>
              <svg
                class="w-6 h-6 text-red-500"
                fill="currentColor"
          ...
          <div
            class="grid grid-cols-4 gap-x-16 py-5 px-4 text-sm text-gray-700 border-b border-gray-200 dark:border-gray-700"
          >
            <div class="text-gray-500 dark:text-gray-400">IB Integration</div>
            <div>
              <svg
                class="w-6 h-6 text-red-500"
                fill="currentColor"
          ...
          <div
            class="grid grid-cols-4 gap-x-16 py-5 px-4 text-sm text-gray-700 border-b border-gray-200 dark:border-gray-700"
          >
            <div class="text-gray-500 dark:text-gray-400">Live Chart</div>
            <div>
              <svg
                class="w-6 h-6 text-red-500"
                fill="currentColor"
          ...
          <div
            class="grid grid-cols-4 gap-x-16 py-5 px-4 text-sm text-gray-700 border-b border-gray-200 dark:border-gray-700"
          >
            <div class="text-gray-500 dark:text-gray-400">Live Stream</div>
            <div>
              <svg
                class="w-6 h-6 text-red-500"
                fill="currentColor"
          ...
          <div
            class="grid grid-cols-4 gap-x-16 p-4 text-sm font-medium text-gray-900 bg-gray-100 border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 dark:text-white"
          >
            <div class="flex items-center">Algo Trading</div>
            <div>Professional Edition</div>
            <div>Advance Edition</div>
            <div>Corporate Edition</div>
          </div>
          ...
          <div
            class="grid grid-cols-4 gap-x-16 py-5 px-4 text-sm text-gray-700 border-b border-gray-200 dark:border-gray-700"
          >
            <div class="text-gray-500 dark:text-gray-400">Back Testing</div>
            <div>
              <svg
                class="w-6 h-6 text-red-500"
                fill="currentColor"
          ...
          >
            ...
            <div>Up to 20 Algorithms/Basket</div>
            <div>Up to 100 Algorithms/Basket</div>
          </div>
          <div
            class="grid grid-cols-4 gap-x-16 p-4 text-sm font-medium text-gray-900 bg-gray-100 border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 dark:text-white"
          >
            <div class="flex items-center">Artificial Intelligence</div>
            <div>Professional Edition</div>
            <div>Advance Edition</div>
            <div>Corporate Edition</div>
          </div>
          <div
            class="grid grid-cols-4 gap-x-16 py-5 px-4 text-sm text-gray-700 border-b border-gray-200 dark:border-gray-700"
          >
            <div class="text-gray-500 dark:text-gray-400">AI Assistant</div>
            <div>
              <svg
                class="w-6 h-6 text-red-500"
                fill="currentColor"
          ...
          <div
            class="grid grid-cols-4 gap-x-16 py-5 px-4 text-sm text-gray-700 border-b border-gray-200 dark:border-gray-700"
          >
            <div class="text-gray-500 dark:text-gray-400">AI Coaching</div>
            <div>
              <svg
                class="w-6 h-6 text-red-500"
                fill="currentColor"
          ...
          <div
            class="grid grid-cols-4 gap-x-16 p-4 text-sm font-medium text-gray-900 bg-gray-100 border-t border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 dark:text-white"
          >
            <div class="flex items-center">Cloud Infrastructure</div>
            <div>Professional Edition</div>
            <div>Advance Edition</div>
            <div>Corporate Edition</div>
          </div>
          <div
            class="grid grid-cols-4 gap-x-16 py-5 px-4 text-sm text-gray-700 border-b border-gray-200 dark:border-gray-700"
          >
            <div class="text-gray-500 dark:text-gray-400">Meta Trader 4</div>
            <div>
              <svg
                class="w-6 h-6 text-green-500"
                fill="currentColor"
          ...
          <div
            class="grid grid-cols-4 gap-x-16 py-5 px-4 text-sm text-gray-700 border-b border-gray-200 dark:border-gray-700"
          >
            <div class="text-gray-500 dark:text-gray-400">Meta Trader 5</div>
            <div>
              <svg
                class="w-6 h-6 text-green-500"
                fill="currentColor"
          ...
          <div
            class="grid grid-cols-4 gap-x-16 py-5 px-4 text-sm text-gray-700 border-b border-gray-200 dark:border-gray-700"
          >
            <div class="text-gray-500 dark:text-gray-400">StrategyQuant X</div>
            <div>
              <svg
                class="w-6 h-6 text-red-500"
                fill="currentColor"
