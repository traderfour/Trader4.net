    ...
    <div class="py-8 mx-auto max-w-screen-2xl sm:py-16">
      <div class="grid gap-16 lg:grid-cols-3">
        <div class="hidden lg:block">
          ...
          >
            <a href="mailto:info@trader4.net">info@trader4.net</a>
          </p>
          <h4 class="mt-4 mb-1 font-medium text-gray-900 dark:text-white">
            Support
          </h4>
          <p
            class="text-sm font-medium text-primary-600 hover:underline dark:text-primary-500"
          >
            <a href="mailto:support@trader4.net">support@trader4.net</a>
          </p>
          <h4 class="mt-4 mb-1 font-medium text-gray-900 dark:text-white">
            Sales
          </h4>
          <p
            class="text-sm font-medium text-primary-600 hover:underline dark:text-primary-500"
          >
            <a href="mailto:sales@trader4.net">sales@trader4.net</a>
          </p>
          <h3
