<template>
  <main class="pt-8 pb-16 lg:pt-16 lg:pb-24">
    <div class="flex justify-between px-4 mx-auto">
        ...
        <div class="sticky" id="aside-item">
          <aside aria-labelledby="reactions-label" class="mb-2">
            ...
            <div class="flex items-center justify-between mb-2">
              <button
                type="button"
                class="py-2 px-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800"
              >
                <svg
                  aria-hidden="true"
                  class="h-6 mb-1"
      ...
      >
        ...
        <p>
          You'll also receive a lot of useful application UI, Publisher UI, and
    ...
    &lt;/dl&gt;
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <div
                      class="flex-wrap items-center space-x-1 sm:pl-4 hidden sm:flex"
                    >
                      <button
                        type="button"
                        class="p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600"
            ...
            <div class="flex">
              <div class="mr-4">
                ...
                >
                  ...
                  <span
                    class="text-gray-900 font-m py-1 px-2 lg:px-0 text-xs lg:text-sm dark:text-white"
                    >14</span
                  >
                  <button
                    type="button"
      ...
      <aside class="hidden lg:block lg:w-72" aria-labelledby="sidebar-label">
        <div class="sticky" id="aside-item">
          ...
          <div
            class="p-6 mb-6 text-gray-500 rounded-lg border border-gray-200 dark:border-gray-700 dark:text-gray-400"
          >
            ...
            <dl class="mb-5">
              <dt
                class="mb-2 text-sm font-bold text-gray-900 uppercase dark:text-white"
              >
                Location
              </dt>
              <dd class="mb-3 text-sm text-gray-500 dark:text-gray-400">
            ...
            <ul class="space-y-4 font-light text-gray-500 dark:text-gray-400">
              <li class="flex justify-between items-start">
                ...
                <div class="mr-3">
                  <span class="block font-medium text-gray-900 dark:text-white"
                    >Bonnie Green</span
                  >
                  <span class="text-sm">Web developer at Facebook</span>
                </div>
                <div>
                  <button
                    type="button"
              ...
              <li class="flex justify-between items-start">
                ...
                <div class="mr-3">
                  ...
                  >
                  <span class="text-sm"
                    >Software enginner at Alphabet Inc.</span
                  >
                </div>
                <div>
                  <button
              ...
              <li class="flex justify-between items-start">
                ...
                <div class="mr-3">
                  <span class="block font-medium text-gray-900 dark:text-white"
                    >Paul Livingston</span
                  >
                  <span class="text-sm">Figma designer at Adobe Inc.</span>
                </div>
                <div>
                  <button
                    type="button"
  ...
  <section class=" ">
    <div class="p-4 py-12 mx-auto max-w-screen-xl text-center lg:py-24">
      ...
      <p
        class="mx-auto mb-8 max-w-2xl text-lg text-gray-500 lg:text-xl dark:text-gray-400"
      >
        Millions of tech blogs publish on Flowbite daily.
      </p>
      <a
        href="#"
        class="py-3 px-5 w-full text-sm font-medium text-white bg-primary-700 rounded-lg hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800"
        >Create an account</a
      >
    </div>
  </section>
