<template>
    ...
    <div class="py-8 px-4 mx-auto lg:py-16">
      <div class="grid gap-8 items-center mb-8 lg:mb-24 lg:gap-12 lg:grid-cols-12">
        <div class="col-span-6 text-center sm:mb-6 lg:text-left lg:mb-0">
          <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl xl:text-6xl dark:text-white">Market, Access reliable market data!</h1>
          <p class="mx-auto mb-6 max-w-xl font-light text-gray-500 lg:mx-0 xl:mb-8 md:text-lg xl:text-xl dark:text-gray-400">
            As an investor, you understand the importance of having accurate market data at your fingertips. In today's fast-paced financial world, making informed investment decisions requires access to real-time data that is both comprehensive and reliable. That's where Market comes in. Our product provides all the information you need to make well-informed decisions and stay ahead of market trends.
          </p>
          <form action="#">
      ...
      <div class="grid grid-cols-2 gap-8 mx-auto text-gray-500 sm:gap-12 md:grid-cols-3 lg:grid-cols-6 dark:text-gray-400">
  ...
  <div class="mx-auto mt-20">
      <div class="mb-8 lg:mb-16">
          <h2 class="mb-4 text-4xl tracking-tight font-bold text-gray-900 dark:text-white">What is Market?</h2>
          <p class="font-light text-gray-500 dark:text-gray-400 sm:text-xl">Market is a highly customizable product that provides comprehensive data on different markets, brokers, platforms, quotes, commissions, and more. We pride ourselves on providing accurate and up-to-date data that allows users to make informed investment decisions. To get started with Market, simply sign up and get your API key.</p>
      </div>
      <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-8 xl:gap-12 md:space-y-0">
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white text-gray-900">Market Data</h3>
              <ul role="list" class="my-6 lg:mb-0 space-y-4">
                  <li class="flex space-x-2.5">
                      ...
                      <span class="leading-tight text-gray-500 dark:text-gray-400">Forex</span>
                  </li>
                  <li class="flex space-x-2.5">
                      <!-- Icon -->
                      <svg class="flex-shrink-0 w-5 h-5 text-primary-600 dark:text-primary-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                      <span class="leading-tight text-gray-500 dark:text-gray-400">US Stocks</span>
                  </li>
                  <li class="flex space-x-2.5">
                      <!-- Icon -->
                      <svg class="flex-shrink-0 w-5 h-5 text-primary-600 dark:text-primary-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                      <span class="leading-tight text-gray-500 dark:text-gray-400">EU Stocks</span>
                  </li>
                  <li class="flex space-x-2.5">
                      <!-- Icon -->
                      <svg class="flex-shrink-0 w-5 h-5 text-primary-600 dark:text-primary-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                      <span class="leading-tight text-gray-500 dark:text-gray-400">Futures</span>
                  </li>
                  <li class="flex space-x-2.5">
                      <!-- Icon -->
                      <svg class="flex-shrink-0 w-5 h-5 text-primary-600 dark:text-primary-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                      <span class="leading-tight text-gray-500 dark:text-gray-400">Crypto</span>
                  </li>
              </ul>
          </div>
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white text-gray-900">Brokers</h3>
              <ul role="list" class="my-6 lg:mb-0 space-y-4">
                  <li class="flex space-x-2.5">
                      <!-- Icon -->
                      ...
                      <span class="leading-tight text-gray-500 dark:text-gray-400">Trading Platforms</span>
                  </li>
                  <li class="flex space-x-2.5">
                      <!-- Icon -->
                      <svg class="flex-shrink-0 w-5 h-5 text-purple-600 dark:text-purple-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                      <span class="leading-tight text-gray-500 dark:text-gray-400">Legal Information</span>
                  </li>
                  <li class="flex space-x-2.5">
                      <!-- Icon -->
                      <svg class="flex-shrink-0 w-5 h-5 text-purple-600 dark:text-purple-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                      <span class="leading-tight text-gray-500 dark:text-gray-400">Cashback</span>
                  </li>
                  <li class="flex space-x-2.5">
                      <!-- Icon -->
                      <svg class="flex-shrink-0 w-5 h-5 text-purple-600 dark:text-purple-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                      <span class="leading-tight text-gray-500 dark:text-gray-400">Compare</span>
                  </li>
              </ul>
          </div>
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white text-gray-900">Platforms</h3>
              <ul role="list" class="my-6 lg:mb-0 space-y-4">
                  <li class="flex space-x-2.5">
                      <!-- Icon -->
                      ...
                      <span class="leading-tight text-gray-500 dark:text-gray-400">Quotes</span>
                  </li>
                  <li class="flex space-x-2.5">
                      <!-- Icon -->
                      <svg class="flex-shrink-0 w-5 h-5 text-teal-500 dark:text-teal-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                      <span class="leading-tight text-gray-500 dark:text-gray-400">Market Watch</span>
                  </li>
                  <li class="flex space-x-2.5">
                      <!-- Icon -->
                      <svg class="flex-shrink-0 w-5 h-5 text-teal-500 dark:text-teal-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                      <span class="leading-tight text-gray-500 dark:text-gray-400">Comissions</span>
                  </li>
                  <li class="flex space-x-2.5">
                      <!-- Icon -->
                      <svg class="flex-shrink-0 w-5 h-5 text-teal-500 dark:text-teal-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                      <span class="leading-tight text-gray-500 dark:text-gray-400">Spreads</span>
                  </li>
              </ul>
          </div>
      </div>
  ...
  <section>
    <div class="items-center py-8 mx-auto lg:gap-8 xl:gap-24 sm:py-16">
      <div class="mb-20">
        <h2 class="mb-4 text-4xl tracking-tight font-bold text-gray-900 dark:text-white">Why Choose Market?</h2>
        <p class="mb-4 text-gray-500 sm:text-xl dark:text-gray-400">It offers a range of features that make it easy to customize, filter, and sort information based on your specific needs and preferences. This ensures that you get the right data at the right time, enabling you to make informed investment decisions.</p>
      </div>
      <div class="col-span-2 space-y-8 md:grid md:grid-cols-3 md:gap-12 md:space-y-0">
        <div v-for="feature in features">
          <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
            <Icon :name="feature.icon" class="w-5 h-5 text-primary-600 lg:w-6 lg:h-6 dark:text-primary-300" />
          </div>
          <h3 class="mb-2 text-xl font-semi dark:text-white">{{ feature.title }}</h3>
  ...
  <section>
    <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div class="mx-auto max-w-screen-sm text-center">
            <h2 class="mb-4 text-4xl tracking-tight font-bold leading-tight text-gray-900 dark:text-white">Access to Market Today!</h2>
            <p class="mb-6 font-light text-gray-500 dark:text-gray-400 md:text-lg">Try T4 Market service to make a memorable trading experience.</p>
